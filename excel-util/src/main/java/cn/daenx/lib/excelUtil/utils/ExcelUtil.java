package cn.daenx.lib.excelUtil.utils;

import cn.daenx.lib.excelUtil.core.*;
...
public class ExcelUtil {
     ...
     * @return 转换后集合
     */
    public static <T> List<T> importExcelQuick(InputStream is, Class<T> clazz) {
     ...
     * <p>
     * 使用案例：
     * ExcelResult<TestDataImportVo> excelResult = ExcelUtil.importExcel(file.getInputStream(), TestDataImportVo.class);
     ...
     * ReadRetVo<TestSheetAVo> sheetA = ExcelUtil.readSheet("班级信息", TestSheetAVo.class);
     * ReadRetVo<TestSheetBVo> sheetB = ExcelUtil.readSheet("学生信息", TestSheetBVo.class);
     ...
     * 读取一个sheet
     */
    public static <T> ReadRetVo<T> readSheet(String sheetName, Class<T> clazz) {
        DefaultExcelListener<T> listener = new DefaultExcelListener<>();
    ...
    public static <T> void exportXlsx(HttpServletResponse response, String fileName, String sheetName, List<T> list, Class entityClass) {
        ...
        try {
            ...
            throw new RuntimeException("导出XLS时发生错误");
        }
